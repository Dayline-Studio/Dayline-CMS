...
class Config
{
    ...
    public static function loadSettings()
    {
        ...
        self::$path = array(
            ...
            'additional' => "$base/dc-storage/include/",
            ...
            'storage' => $base.'/dc-storage/',
            'storage_rel' => $subfolder.'/dc-storage/',
            ...
            'template' => "$subfolder/dc-storage/templates/" . self::$settings->style . '/',
            'template_abs' => "$base/dc-storage/templates/" . self::$settings->style . '/',
            'template_default' => "$subfolder/dc-inc/style/",
            'template_default_abs' => "$base/dc-inc/style/",
