    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '../inc/images/socialshareprivacy/dummy_facebook.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'action'            : 'recommend',
                    'layout'            : 'button_count',
                    'sharer'            : {
                        'status'        : 'off',
                        'dummy_img'     : '../inc/images/socialshareprivacy/dummy_facebook_share_de.png',
                        'img'           : '../inc/images/socialshareprivacy/dummy_facebook_share_active_de.png'
                    }
                },
                'twitter' : {
                    'status'            : 'on',
                    'dummy_img'         : '../inc/images/socialshareprivacy/dummy_twitter.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '../inc/images/socialshareprivacy/dummy_gplus.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'size'              : 'medium'
                }
